...
We continue to grind out [Doltgres correctness fixes](https://www.dolthub.com/blog/2025-07-08-doltgres-correctness-testing/). The Postgres syntax is much more expansive than that of MySQL. We continue to discover interesting SQL, like [set returning functions](https://www.dolthub.com/blog/2025-06-27-postgres-set-functions-are-weird/). 

We are on the cusp of announcing [extension support](https://www.dolthub.com/blog/2025-06-06-loading-native-extensions/), so stay tuned if you're waiting for those to jump into Doltgres. We're definitely ready, willing, and able to work with a motivated user to be the first example Doltgres user. Just reply to this email if you think that could be you.
